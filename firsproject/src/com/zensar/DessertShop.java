...
public class DessertShop {
	...
	public static void main(String[] args) {
		...
		System.out.println("Number of items: 3");
		System.out.println("How many candies you want: 4");
		System.out.println("How many cookies you want: 3");
		System.out.println("How many icecream you want: 5");
		while(true) {
