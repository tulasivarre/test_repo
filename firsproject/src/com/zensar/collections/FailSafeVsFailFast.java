...
// List<Integer> arrayList = new CopyOnWriteArrayList<Integer>(); //Fail-Safe
// iterator

// Map<String, Integer> hashMap = new HashMap<String, Integer>(); //Fail-Fast iterator
Map<String, Integer> hashMap = new ConcurrentHashMap<String, Integer>(); ////Fail-Safe
// iterator
...
hashMap.put("tula", 101);
hashMap.put("vinee", 102);
hashMap.put("sai", 103);
hashMap.put("santhu", 104);
